  ...
  return (
    <>
      <div className="text-white mb-5 mt-4 ">
        <div className="inline-block h-[500px] w-[350px] md:w-[350px] lg:w-[340px] pb-4 max-w-md     align-middle bg-transparent  border-2 border-yellow-500/70 shadow-lg shadow-blue-700 rounded-xl">
          <div className="grid grid-col-4 text-center  ">
            <div className="">
