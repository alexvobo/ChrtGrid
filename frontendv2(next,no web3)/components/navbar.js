...
export default function Example() {
  ...
  return (
    <Disclosure
      as="nav"
      className="bg-[#010C27] border-b-2 border-yellow-600 mb-8">
      {({ open }) => (
        <>
            ...
            <div className="relative flex items-center justify-between h-16">
              ...
              <div className="flex-1 flex items-center justify-center sm:items-stretch sm:justify-start">
                <div className="flex-shrink-0 flex items-center">
                  <h1 className="text-white">Gridly</h1>
                </div>
              ...
              <div className="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
                ...
                {/* Connect Wallet/Account Dashboard */}
                <Menu as="div" className="ml-3 relative">
                  <button
                    className="flex bg-transparent hover:bg-red-500 text-red-700 font-semibold hover:text-black py-2 px-4 border border-red-500 hover:border-transparent rounded "
